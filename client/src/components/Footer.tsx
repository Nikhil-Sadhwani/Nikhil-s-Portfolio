...
const Footer: React.FC = () => {
  return (
    <footer className="bg-zinc-900 text-white flex justify-between items-center">
      <div className="flex items-center space-x-4">
        <a
          href="https://github.com/Nikhil-Sadhwani"
          target="_blank"
          className="flex text-zinc-300 hover:bg-zinc-700  hover:text-white w-[54px] gap-1 p-[2px] ml-[25px]"
        >
          <svg
        ...
        <div className="flex items-center text-zinc-300 hover:bg-zinc-700  hover:text-white cursor-pointer">
          <svg
            width="14"
            height="14"
            viewBox="0 0 16 16"
      ...
      <div className="flex items-center space-x-4  mr-2">
        <div className="flex items-center space-x-1 text-zinc-300 hover:bg-zinc-700  hover:text-white cursor-pointer">
          <svg
            width="14"
            fill="currentColor"
            viewBox="0 0 24 24"
